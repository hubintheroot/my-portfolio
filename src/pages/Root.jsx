            ...
            worked: [
              {
                ...
                descCause: `OpenAPI의 사용량이 초당 1호출로 제한되어 발생한 문제임을 확인했습니다.`,
                myPlan: `OpenAPI의 데이터가 정기적인 업데이트를 통해 변경되는 점을 고려하여 OpenAPI와 사용자 사이에 DB를 추가하여 해결하고자 했습니다.`,
                solution: `DB는 백엔드 서비스 플랫폼 firebase와 supabase 중 정형 데이터를 다루는 프로젝트에 적합한 관계형DB인 supabase의 PostgreSQL를 선택했습니다.
                django의 crontab을 활용하여 주기적인 데이터 업데이트를 구현하여 OpenAPI 사용량의 문제를 해결하여 100명의 접속에도 문제없이 데이터를 제공했습니다.`,
                learningPoint: ``,
              },
              {
                key: 2,
                ...
                redux storage에 저장된 데이터를 확인하는 로직과 비동기 요청 중 새로 요청하는 문제를 방지하기 위한 로직을 추가하여 데이터 요청 중복 문제를 해결했습니다.`,
                learningPoint: ``,
              },
              {
                key: 3,
                ...
                learningPoint: `이 경험을 통해 사용자에게 제공할 서비스를 어떻게 보여줄지 고민하고, styled components와 component의 상태관리를 전역관리 툴을 활용하는 역량을 키울 수 있었습니다.`,
              },
              {
                key: 4,
                ...
                이러한 방식으로 로딩 시간을 개선하는 것은 한계가 명확하다고 판단하여 기존의 프로젝트 public폴더에서 관리하던 이미지 파일을 github의 레포지토리와 jsdelivr의 cdn 서버를 활용하여 관리하고, 로딩 시간을 개선하기로 했습니다.`,
                solution: `우선 이미지 최적화를 통해 약 이미지 파일의 30%의 용량을 축소했습니다.
                또한, 기존의 이미지 관리 방식으로 로딩 시간을 약 0.5초가량 단축한 로딩 시간을 github와 jsdelivr를 활용한 이미지 관리 방식으로 변경하면서 가장 큰 이미지의 로딩 시간을 1초로 줄일 수 있었습니다.`,
                learningPoint: `성능 개선을 위해 고민하고 실제 성능을 개선하는 과정을 겪으며, 역량향상을 느꼈고 성취감 또한 느낄 수있는 경험이었습니다.`,
              },
            ],
            useTools: [
              "react.js",
